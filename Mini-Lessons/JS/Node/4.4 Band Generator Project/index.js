...
function generateFunnyName() {
  ...
  var randomAdjNumber = Math.floor(Math.random() * adjLength);
  var randomNounNumber = Math.floor(Math.random() * nounLength);

  var randomAdj = adj[randomAdjNumber];
  var randomNoun = noun[randomNounNumber];
